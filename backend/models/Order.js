...
// Phục vụ Dashboard và danh sách order; đặt ngày trước để cả truy vấn chỉ có
// ngày lẫn truy vấn ngày + trạng thái đều dùng được index.
orderSchema.index({ "days.date": 1, status: 1 });
