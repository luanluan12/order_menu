...
function CheckinQrModal({ open, onClose }) {
  ...
  const loadTodayCheckins = async () => {
    try {
      ...
      console.error("Không tải được danh sách check-in:", err);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
      <div className="w-full max-w-md rounded-3xl bg-white shadow-xl">
        ...
        <div className="p-6">
          {loading ? (
            <div className="py-16 text-center">Đang tải QR...</div>
          ) : (
            qr && (
              <>
                ...
                <div className="mt-8">
                  <h3 className="mb-3 text-lg font-bold">Đã nhận hôm nay</h3>
